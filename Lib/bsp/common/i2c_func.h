...
extern OsErr_t I2c_StartMemoryTx(u8 addr, u16 memory, I2cMemorySize_t memorySize, u8 *pData,
                                 u8 length);
extern OsErr_t I2c_StartMemoryRx(u8 addr, u16 memory, I2cMemorySize_t memorySize, u8 *pData,
                                 u8 length);
