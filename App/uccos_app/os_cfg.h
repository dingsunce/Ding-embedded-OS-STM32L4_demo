...
#define OS_CFG_TRACE_EN                 0u   /* Enables kernel events recording for Trace Analysis                    */
#define OS_CFG_TRACE_API_ENTER_EN       0u   /* Enables kernel events recording for Trace Analysis                    */
#define OS_CFG_TRACE_API_EXIT_EN        0u   /* Enables kernel events recording for Trace Analysis                    */
...
#define OS_CFG_OBJ_CREATED_CHK_EN       0u   /* Enable (1) or Disable (0) object created checking                     */
...
#define OS_CFG_TASK_STK_REDZONE_DEPTH   20
